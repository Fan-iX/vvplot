...
<template>
    <article>
        <section>
            ...
            <pre class="code">import vvscale from 'vvplot/scale'</pre>
            ...
            <div class="grid grid-cols-[3fr_2fr] gap-4">
                <pre class="code">{{templates[1] = `<VVPlot :data="[
    ...
    <VVGeomPoint :x="d => d.x" :y="d => d.y"
        :color="d => d.color" :size="d => d.size" />
            ...
            <div class="grid grid-cols-[3fr_2fr] gap-4">
                <pre class="code">{{templates[2] = `<VVPlot :data="iris" :scales="{
    ...
    <VVGeomPoint :x="d => d.Petal_Width"
        ...
        :color="d => d.Species" />
            ...
            <div class="grid grid-cols-[3fr_2fr] gap-4">
                <pre class="code">{{templates[3] = `<VVPlot :data="UCBAdmissions"
    ...
    <VVAxisX :theme="{ text_angle: -10 }" />
            ...
            <pre class="code">import { oob } from 'vvplot/scale'</pre>
            <p>
            ...
            <div class="grid grid-cols-[3fr_2fr] gap-4">
                <pre class="code">{{templates[4] = `<VVPlot :data="UCBAdmissions"
    ...
    <VVGeomPoint :x="d => d.Petal_Width"
        ...
        :color="d => d.Sepal_Width" />
            ...
            <div class="grid grid-cols-[3fr_2fr] gap-4">
                <pre class="code">{{templates[7] = `<VVPlot :scales="{ shape: vvscale.color.identity() }"
    :data="[
    ...
    <VVGeomPoint :x="d => d" :shape="d => d"
        :y="0" :size="15" />
            ...
            <div class="grid grid-cols-[3fr_2fr] gap-4">
                <pre class="code">{{templates[8] = `<VVPlot :scales="{ linetype: vvscale.linetype.identity() }"
    :data="[
        'solid', 'dashed', 'dotted',
    ...
    <VVGeomLinerange :xmin="0" :xmax="1"
        :y="d => d" :linetype="d => d" />
            ...
            <div class="grid grid-cols-[3fr_2fr] gap-4">
                <pre class="code">{{templates[9] = `<VVPlot :data="letters" :scales="{
