...
<template>
    <g :transform="transform" :style="{ transition }">
        <line :x1="0" :x2="width" :y1="0" :y2="0" v-bind="axisLine" v-if="axisLine.stroke != null" />
        ...
        <g class="vvplot-interactive" fill="transparent">
            <rect ref="i" :width="width" :height="10" :y="-5" v-on="axisVOn" @pointerdown="axisMovePointerdown"
